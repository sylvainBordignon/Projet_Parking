...
public class MethodesGerant {
	...
	// le gérant ne peut pas rentrer un nb > au nb de place qu'il reste en surréservation en cours.
	if (saisieGerant > nbPlaceParking || nbPlaceSurreservationEnCours > saisieGerant ) {
		...
		GerantMysql.getInstance().modifierNbPlaceSurreservationEnCours(nbPlaceSurreservation - nbPlaceSurreservationEnCours);
